...
export const candidateApi = {
  ...
  getWithCallScripts: ()     => api.get('/candidates/with-call-scripts'),
  ...
  markCallDone:   (id)     => api.post(`/candidates/${id}/call-done`),
  unmarkCallDone: (id)     => api.delete(`/candidates/${id}/call-done`),
...
export const settingsApi = {
  ...
  bulkUnsharePin:      (candidateIds) => api.delete('/settings/pins/bulk-share', { data: { candidateIds } }),
